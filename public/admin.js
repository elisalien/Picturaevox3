// public/admin.js V3 - Rendu identique à public + pouvoirs admin
const socket = io({
  reconnection: true,
...
socket.on('adminResetBrushEffects', () => {
  brushManager.clearAllEffects();
  layer.batchDraw();
  console.log('🎨 ADMIN: Brush effects reset');
});
...
console.log('✅ Admin.js V3 loaded - UNIFIED RENDERING with public');
console.log('👑 ADMIN POWERS:');
console.log('   • Global undo: Ctrl+Z (Limited to 2 actions)');
console.log('   • Reset effects: Ctrl+Shift+E or button ✨');
console.log('   • Reset COMPLETE: Ctrl+Shift+R or button 🧼');
console.log('   • Object eraser: 🧽 button');
console.log('   • Same brush rendering as public ✅');
          break;
      }
...
socket.on('clearCanvas', () => {
  ...
  brushManager.clearEverything();
  layer.draw();
  console.log('🧼 ADMIN: Canvas cleared');
});
